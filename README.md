...
A part of my workshop "Build an AI web translator app with Flask", where I taught students how to build a web app using Azure Cognitive services and Flask <br>
